...
from .instructions import build_cancel_perp_order_instructions, build_cancel_all_perp_orders_instructions, build_mango_consume_events_instructions, build_place_perp_order_instructions, build_redeem_accrued_mango_instructions
...
class PerpMarketInstructionBuilder(MarketInstructionBuilder):
    ...
    def build_cancel_all_perp_orders_instructions(self, limit: int = 100) -> CombinableInstructions:
        if self.perp_market.underlying_perp_market is None:
            raise Exception(f"PerpMarket {self.perp_market.symbol} has not been loaded.")
